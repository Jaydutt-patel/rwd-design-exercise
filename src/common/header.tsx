...
import { Cross, Hamburger, Logo, UserProfile } from 'common/svgIcons';
    ...
    return (<div className='header-wrapper'>
        {size >= 1100 && <><div className='desktop-header'>
            ...
            {HEADERLINKS.map((link, index) => (
                <NavLink key={index} className='header-link' activeClassName='active-link' to={link}>{link}</NavLink>
            ))}
        </div>
        ...
        {open && <div className='overlay fadeIn'>
